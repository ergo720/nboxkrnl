...
ULONG KernelThunkTable[379] =
{
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&ExAcquireReadWriteLockExclusive),         // 0x000C (12)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&ExAcquireReadWriteLockShared),            // 0x000D (13)
	(ULONG)FUNC(&ExAllocatePool),                          // 0x000E (14)
	(ULONG)FUNC(&ExAllocatePoolWithTag),                   // 0x000F (15)
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&ExEventObjectType),                   // 0x0010 (16)
	(ULONG)FUNC(&ExFreePool),                              // 0x0011 (17)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&ExInitializeReadWriteLock),               // 0x0012 (18)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&ExReleaseReadWriteLock),                  // 0x001C (28)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoAllocateIrp),                           // 0x003B (59)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoCheckShareAccess),                      // 0x003F (63)
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&IoCompletionObjectType),              // 0x0040 (64)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoCreateDevice),                          // 0x0041 (65)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoCreateFile),                            // 0x0042 (66)
	...
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&IoDeviceObjectType),                  // 0x0046 (70)
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&IoFileObjectType),                    // 0x0047 (71)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoFreeIrp),                               // 0x0048 (72)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoInitializeIrp),                         // 0x0049 (73)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoInvalidDeviceRequest),                  // 0x004A (74)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoRemoveShareAccess),                     // 0x004E (78)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoSetIoCompletion),                       // 0x004F (79)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoSetShareAccess),                        // 0x0050 (80)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeDelayExecutionThread),                  // 0x0063 (99)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeInitializeDeviceQueue),                 // 0x006A (106)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeInitializeMutant),                      // 0x006E (110)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeInsertQueueApc),                        // 0x0076 (118)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeInsertQueueDpc),                        // 0x0077 (119)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeQueryInterruptTime),                    // 0x007D (125)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeQueryPerformanceCounter),               // 0x007E (126)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeQueryPerformanceFrequency),             // 0x007F (127)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeReleaseMutant),                         // 0x0083 (131)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeReleaseSemaphore),                      // 0x0084 (132)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeSetPriorityThread),                     // 0x0094 (148)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeSetTimer),                              // 0x0095 (149)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeSetTimerEx),                            // 0x0096 (150)
	...
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&KeTimeIncrement),                     // 0x009D (157)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeWaitForMultipleObjects),                // 0x009E (158)
	(ULONG)FUNC(&KeWaitForSingleObject),                   // 0x009F (159)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KfRaiseIrql),                             // 0x00A0 (160)
	...
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&LaunchDataPage),                      // 0x00A4 (164)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&MmAllocateContiguousMemory),              // 0x00A5 (165)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&MmAllocateContiguousMemoryEx),            // 0x00A6 (166)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtCreateDirectoryObject),                 // 0x00BC (188)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtCreateMutant),                          // 0x00C0 (192)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtOpenFile),                              // 0x00CA (202)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtQueryVolumeInformationFile),            // 0x00DA (218)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtReadFile),                              // 0x00DB (219)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtReadFileScatter),                       // 0x00DC (220)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtReleaseMutant),                         // 0x00DD (221)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtWaitForSingleObject),                   // 0x00E9 (233)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtWaitForSingleObjectEx),                 // 0x00EA (234)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtWaitForMultipleObjectsEx),              // 0x00EB (235)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtWriteFile),                             // 0x00EC (236)
	...
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&ObDirectoryObjectType),               // 0x00F0 (240)
	(ULONG)FUNC(&ObInsertObject),                          // 0x00F1 (241)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&ObMakeTemporaryObject),                   // 0x00F2 (242) 
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&ObOpenObjectByName),                      // 0x00F3 (243)
	(ULONG)FUNC(&ObOpenObjectByPointer),                   // 0x00F4 (244)
	(ULONG)VARIABLE(&ObpObjectHandleTable),                // 0x00F5 (245)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&ObReferenceObjectByHandle),               // 0x00F6 (246)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&ObReferenceObjectByName),                 // 0x00F7 (247)
	(ULONG)FUNC(&ObReferenceObjectByPointer),              // 0x00F8 (248)
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&ObSymbolicLinkObjectType),            // 0x00F9 (249)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlCaptureStackBackTrace),                // 0x010A (266)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlEqualString),                          // 0x0117 (279)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlEqualUnicodeString),                   // 0x0118 (280)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlExtendedIntegerMultiply),              // 0x0119 (281)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlExtendedLargeIntegerDivide),           // 0x011A (282)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlExtendedMagicDivide),                  // 0x011B (283)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlMapGenericMask),                       // 0x0129 (297)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlNtStatusToDosError),                   // 0x012D (301)
	(ULONG)FUNC(&RtlRaiseException),                       // 0x012E (302)
	(ULONG)FUNC(&RtlRaiseStatus),                          // 0x012F (303)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlTimeFieldsToTime),                     // 0x0130 (304)
	...
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&RtlUpperChar),                            // 0x013C (316)
	...
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&XeImageFileName),                     // 0x0146 (326)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&XeLoadSection),                           // 0x0147 (327)
