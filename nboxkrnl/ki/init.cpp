...
KIDT KiIdt[] = {
	...
	BUILD_IDT_ENTRY(KiTrap0),
	BUILD_IDT_ENTRY(KiTrap1),
	BUILD_IDT_ENTRY(KiTrap2),
	BUILD_IDT_ENTRY(KiTrap3),
	BUILD_IDT_ENTRY(KiTrap4),
	BUILD_IDT_ENTRY(KiTrap5),
	BUILD_IDT_ENTRY(KiTrap6),
	BUILD_IDT_ENTRY(KiTrap7),
	BUILD_IDT_ENTRY(KiTrap8),
	BUILD_IDT_ENTRY(KiUnexpectedInterrupt),
	BUILD_IDT_ENTRY(KiTrap10),
	BUILD_IDT_ENTRY(KiTrap11),
	BUILD_IDT_ENTRY(KiTrap12),
	BUILD_IDT_ENTRY(KiTrap13),
	BUILD_IDT_ENTRY(KiTrap14),
	BUILD_IDT_ENTRY(KiUnexpectedInterrupt),
	BUILD_IDT_ENTRY(KiTrap16),
	BUILD_IDT_ENTRY(KiTrap17),
	BUILD_IDT_ENTRY(KiTrap18),
	BUILD_IDT_ENTRY(KiTrap19),
	BUILD_IDT_ENTRY(KiUnexpectedInterrupt),
	BUILD_IDT_ENTRY(KiUnexpectedInterrupt),
	BUILD_IDT_ENTRY(KiUnexpectedInterrupt),
	BUILD_IDT_ENTRY(KiUnexpectedInterrupt),
